...
### This file describes the variables, the data, and any transformations or summaries that has been performed for the Project

* The data for the project was obtained from:  
  *https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip* 
* The run_analysis.R script performs the following steps to clean the data, merge it and generate output:   
